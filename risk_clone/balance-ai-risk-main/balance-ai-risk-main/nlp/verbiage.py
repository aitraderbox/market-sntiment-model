...
class Verbiage:
    ...
    def decorate_verbiage(self, risk: 'Risk', dictionary):
        ...
        if '{direction}' in word_list or '{direction},' in word_list or '{direction}.' in word_list:
            verbiage = re.sub('{direction}', dictionary[risk.get_param2('param_4')], verbiage, 1)
